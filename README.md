# Segs.io
This repository is for segs.io code, configs, scripts, themes, and issues related to AppVeyor, Discord (including bots and hooks), DNS, Docker, Doxygen, @segs.io e-mail, the forum, GitLab, IRC (including bots), Jenkins, SSH access, Travis CI, and the community test servers (blue/red).
